 ...
 */
//这个适配器适用于推荐栏目下的列表格式
public class AfterSomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AfterSomeAdapter(Context context, List listT, FragmentActivity activity) {
